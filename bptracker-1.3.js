...
$("form").submit(function(e) {var self = this;e.preventDefault();_gaq.push(['_trackEvent', 'Form Submit', 'Form Name: '+$(this).attr('name')+', Form ID: '+$(this).attr('id')+', Form Method: '+$(this).attr('method')+', Form Action: '+$(this).attr('action'), document.title,0,true]);setTimeout(self.submit(), 250);return false;});
if (typeof bptrackercongif!=='undefined'){ 
if (bptrackercongif.trackmobile==true){  if ("onhashchange" in window) { // event supported?
